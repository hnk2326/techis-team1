...
class UserRegisterController extends Controller
{
    ...
    public function UserRegister(Request $request)
    {
        ...
        $this->validate($request,[
            ...
            'email' => 'required|email|max:255|unique:users', // 必須、@を含むアドレス、最大文字数255文字、uesrsテーブルに同じメールアドレスがあったらダメ
            'password' => 'required|string|between:8,16|confirmed', // 必須、文字列(数字も可)、8～16文字、パスワード確認用が同じか
